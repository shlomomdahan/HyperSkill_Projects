...
''' 
1. you have to look for all the articles on the current page
2. Create a folder by the name `Page_<current_page_number (e.g. 1, 2, ..)>` 
3. Then go to each of the links you found on the current page
4. Extract their content
5. Create a file by their title name (made with `_` instead of spaces) inside the folder you created in step 2
6. Write the extracted content onto the file
7. Repeat steps 1 - 7 until you reach to n
'''